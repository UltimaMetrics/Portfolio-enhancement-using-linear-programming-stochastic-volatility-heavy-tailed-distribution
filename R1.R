...
KP_R1 <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/KP_R1.xlsx")
...
TWA50R <- as.matrix(R1)
kpol<-as.matrix(KP_R1)
ksi<-as.matrix(KSI)
KB<-as.matrix(KBUY)

#which(stock_matrix==NA)

length(problem.list$matrix_inmmax)<-57018
dim(problem.list$matrix_inmmax)<-c(51, 1118)
