...
#FSOS <- read_excel("FSOS.xlsx")
#KP_FSOS <- read_excel("KP_FSOS.xlsx")
#KBUY <- read_excel("KBUY.xlsx")
#KSI <- read_excel("KSI.xlsx")
FSOS <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/FSOS.xlsx")
KP_FSOS <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/KP_FSOS.xlsx")
...
TWA50R <- as.matrix(FSOS)
kpol<-as.matrix(KP_FSOS)
ksi<-as.matrix(KSI)
KB<-as.matrix(KBUY)

#which(stock_matrix==NA)

length(problem.list$matrix_inmmax)<-27030
dim(problem.list$matrix_inmmax)<-c(51,530)
