...
KP_R2 <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/KP_R2.xlsx")
...
TWA50R <- as.matrix(R2)
kpol<-as.matrix(KP_R2)
ksi<-as.matrix(KSI)
KB<-as.matrix(KBUY)

#which(stock_matrix==NA)

length(problem.list$matrix_inmmax)<-19278
dim(problem.list$matrix_inmmax)<-c(51, 378)
