...
FSIS <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/FSIS.xlsx")
KP_FSIS <- read_excel("D:/Stony Brook AMS/AMS 2021 Fall/AMS 518 Stochastic and Optimization/AMS518 project/AMS518 Final Project submission_Chi-Sheng Lo/TW50 index tracking project/KP_FSIS.xlsx")
...
TWA50R <- as.matrix(FSIS)
kpol<-as.matrix(KP_FSIS)
ksi<-as.matrix(KSI)
KB<-as.matrix(KBUY)

#which(stock_matrix==NA)

length(problem.list$matrix_inmmax)<-107712
dim(problem.list$matrix_inmmax)<-c(51, 2112)
